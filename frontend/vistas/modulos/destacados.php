...
<figure class="banner">
	...
	<img src="http://localhost/storeweb/backend/vistas/img/banner/default.jpg" class="img-responsive" width="100%">
...
$rutasModulos = array("articulos-gratis", "lo-mas-vendidos", "lo-mas-visto");
			...
			echo '
				<li class="col-md-3 col-sm-6 col-xs-12">
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/'.$value["portada"].'"
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio04.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio03.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio02.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio01.jpg"
							class="img-responsive">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img
								src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio04.jpg"
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img
								src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio03.jpg"
								class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img
								src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio02.jpg"
								class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img
								src="http://localhost/storeweb/backend/vistas/img/productos/accesorios/accesorio01.jpg"
								class="img-responsive"></a>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/ropa/ropa03.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/ropa/ropa04.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/ropa/ropa02.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/ropa/ropa06.jpg"
							class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso05.jpg"
							class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404"
							imagen="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso05.jpg"
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso04.jpg"
							class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404"
							imagen="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso04.jpg"
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso02.jpg"
							class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404"
							imagen="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso02.jpg"
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso03.jpg"
							class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404"
							imagen="http://localhost/storeweb/backend/vistas/img/productos/cursos/curso03.jpg"
